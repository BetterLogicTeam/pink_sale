  ...
  return (
    <div className="d-block d-md-none py-3 px-0 ">
      <div className=" d-flex align-items-center justify-content-around index_canva">
        <AiOutlineMenu
          className="color-expant size_of_pink "
          onClick={handleShow}
        />
      ...
      <Offcanvas
        ...
        onHide={handleClose}
        responsive=""
        className="width_canvas "
      >
         
        <Offcanvas.Header className="d-flex justify-content-end pb-0"> <AiOutlineClose className=" text-white pointer_click icon_size" onClick={handleClose}/></Offcanvas.Header>
        <Offcanvas.Body className="px-0">
          <div>
            <div className="HOVER text-start ps-3 pt-1 d-flex align ">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
            ...
            <Accordion
              className="border-none p-0 shadow_launch accordian_color_blue"
              disableGutters
            ...
            >
              <AccordionSummary
                expandIcon={
                  <ExpandMoreIcon className="expand_icon color-expant" />
                }
              ...
              <AccordionDetails className="bg-color-lonch">
                <Typography>
          ...
          <div className="HOVER text-start ps-3 pt-3 d-flex align mb-5 ">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
