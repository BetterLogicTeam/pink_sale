    ...
    if (acc == "No Wallet") {
      ...
      try {
        ...
        let transferOwnerShip = await pinkSaleContract.methods
          .transferLockOwnership(id, transferOwnership)
          .send({ from: acc });
      } catch (e) {
        // setSpinner(false);
            ...
            <div className="col-lg-10 bg-white mt-4">
              ...
              <div className="my-4">
                ...
                <div className="last_butn_main py-2 mt-3 ">
                  ...
                  <button type="button" className="btn btn-sm fst_bB">
                    Update
                  </button>
                  <button type="button" className="btn btn-sm fst_bB" disabled>
                    Unlock
                  </button>
                </div>
              </div>
