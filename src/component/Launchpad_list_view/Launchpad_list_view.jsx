  ...
  return (
    <Doughnut
      data={{
        ...
        labels: ["Presale", "Laquidity", "Unlock", "Burnt"],
        datasets: [
          {
            label: "# of votes",
            data: [12, 19, 8, 2],
...
function Launchpad_list_view() {
  return (
    <div className="container mmain_clc p-0">
      <div className="row">
          ...
          <div className="row d-flex justify-content-center">
            <div className="col-lg-11 col-sm-12">
                    ...
                    <div className="col-lg-10 col-sm-12 lft_boox">
                      <div className="heading_outer_layer d-flex justify-content-between ">
                        ...
                        <div className="right_item">
                          <p className=" p_bg text-white px-2 gap-1">
                            <svg
                              stroke="currentColor"
                              fill="currentColor"
                              stroke-width="0"
                      ...
                      <div className="icons_outer d-flex ">
                        <div className="icon_1">
                          <TbWorld className="con_siz" />
                        </div>
                        <div className="icon_2">
                          <FiTwitter className="con_siz" />
                        </div>
                        <div className="icon_3">
                          <RiFacebookCircleLine className="con_siz" />
                        </div>
                        ...
                        <div className="icon_5">
                          <AiOutlineInstagram className="con_siz" />
                        </div>
                        <div className="icon_6">
                          <BsDiscord className="con_siz" />
                        </div>
                      </div>

                      <div className="detail_box mt-4">
                        <p className="perag text-start">
                          A powerful exchange that comprises the power of two
                          potential exchanges of the cryptocurrency market is
                          the Hybrid Exchange. It is an exchange platform that
                          amalgamates the features of both centralized and
                          decentralized exchanges, it is best suited for big
                          businesses and revenue-driven models. And in the end,
                          what the user gets is a highly-secure, user-friendly,
                          reliable and transparent exchange for allowing traders
                          and investors to make fair and unbiased decisions.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-sm-12 view_shade view_tow text-white">
                  ...
                  <div className="feild my-4">
                    <Form>
                      ...
                      <div className="btn_uper_layer d-flex justify-content-start">
                        <Button
                          variant="primary "
              ...
              <div className="row justify-content-start mt-4">
                <div className="col-lg-7 col-sm-12 view_shade text-white py-4">
                  <div className="text-start border-bottom">
                    <h5 className="fw-bold" >Token Metrics</h5>
                  </div>
                  <div className="chart_outer_layer mt-3">
