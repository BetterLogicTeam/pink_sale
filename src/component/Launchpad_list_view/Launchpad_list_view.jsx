        ...
        <div className="col-lg-12 py-5 px-4 main_shade">
                    ...
                    <table className="table">
                      <tbody>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          ...
                          <td className='for_blu brd_no'>Liquidity will not be automatically added!</td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Presale Address</td>
                          <td className='for_blu brd_no'><a href="" className='text-decoration-none'> 0xd34bF1Cf09da6009C91Caa98107C42174e049DF5</a></td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                        ...
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          ...
                          <td className='for_blu brd_no'><a href="" className='text-decoration-none'> 0x2263f9585f891F5AE6C281834Bc6D330c203A60e</a></td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Total Supply</td>
                          <td className='text-white brd_no'>1,000,000,000 EPN</td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Tokens For Presale</td>
                          <td className='text-white brd_no'>152,000,000 EPN</td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Presale Rate</td>
                          <td className='text-white brd_no'>1 BNB = 9,500 EPN</td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                        ...
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Presale Start Time</td>
                          <td className='text-white brd_no'>2023.01.17 00:02 (UTC)</td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Presale End Time</td>
                          <td className='text-white brd_no'>2023.03.07 00:03 (UTC)</td>
                        </tr>
                        <tr className='d-flex justify-content-between trr_brd_b'>
                          <td className='text-white brd_no'>Liquidity Percent</td>
                  ...
                  <div className="feild my-4">
                    <Form>
                      ...
                      <div className="btn_uper_layer d-flex justify-content-md-start justify-content-center">
                        <Button variant="primary " className='text-start swit_bbtn' type="submit">Switch Network To BSC</Button>
                      </div>
                    </Form>
                  </div>
          ...
          <div className="row warn_box justify-content-center mt-5">
            <div className="col-lg-9 col-sm-9">
              <p className='text-white'>Disclaimer: The information provided shall not in any way constitute a recommendation as to whether you should invest in any product discussed. We accept no liability for any loss occasioned to any person acting or refraining from action as a result of any material provided or published</p>
            </div>
          </div>
